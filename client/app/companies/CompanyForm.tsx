...
export default function CompanyForm() {
  ...
  const onSubmit: SubmitHandler<CompanyFormData> = (data, event) => {
    ...
    try {
      ...
      addMessage("Entreprise créée avec succès, vérifiez votre email pour l'OTP", "success");
  ...
  return (
    <div className="">
      <div className="company-form p-6 max-w-4xl mx-auto bg-white dark:bg-neutral-dark-surface rounded-lg shadow-md">
