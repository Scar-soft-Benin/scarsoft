// ~/companies/job-management/JobForm.tsx
...
import TagInput from "../../dashboard/components/tagInput";
...
export default function CompanyJobForm({ job, onSave, onCancel }: JobFormProps) {
