...
export const GET_JOBAPPLICATION = "GET_JOBAPPLICATION";
...
export const getAllJobApplicationsFailure = (error: {
    ...
    type: `${GET_ALL_JOBAPPLICATIONS}_FAILURE`,
    payload: error
});

export const getJobApplicationSuccess = (response: CreateJobApplicationResponse) => ({
    type: `${GET_JOBAPPLICATION}_SUCCESS`,
    payload: response
});
export const getJobApplicationFailure = (error: {
    message: string;
    error_code?: string;
}) => ({
    type: `${GET_JOBAPPLICATION}_FAILURE`,
    payload: error
});
export const updateJobApplicationStatusSuccess = (response: UpdateJobApplicationStatusResponse) => ({
    type: `${UPDATE_JOBAPPLICATION_STATUS}_SUCCESS`,
    payload: response
});
...
export const deleteJobApplicationFailure = (error: {
    ...
    type: `${DELETE_JOBAPPLICATION}_FAILURE`,
    payload: error
});
...
function* getJobApplicationSaga(action: { type: typeof GET_JOBAPPLICATION; payload: string }) {
    try {
        ...
        yield put(getJobApplicationSuccess(response.data));
    } catch (error: unknown) {
        ...
        yield put(getJobApplicationFailure(apiError));
        yield put(
            addMessage({
                type: "error",
