...
export const GET_ALL_JOBS_BY_COMPANY_ID_SUCCESS =
    "GET_ALL_JOBS_BY_COMPANY_ID_SUCCESS";
export const GET_ALL_JOBS_BY_COMPANY_ID_FAILURE =
...
type JobAction =
    ...
    | {
          type: typeof GET_ALL_JOBS_FOR_ADMIN_SUCCESS;
          payload: GetAllJobsResponse;
      }
    | {
    ...
    | {
          type: typeof GET_ALL_JOBS_BY_COMPANY_ID_SUCCESS;
          payload: GetAllJobsByCompanyIdResponse;
      }
    | {
