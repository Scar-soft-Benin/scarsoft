...
const CareerApplication = () => {
    ...
    const handleEmailApplication = () => {
        if (job) {
            const subject = `${t("careerApplication.application")} - ${
                job.title
            }`;
            const body = `${t("careerApplication.emailBody", {
                title: job.title
            })}`;
            window.open(
            ...
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <h2 className="text-2xl font-bold text-gray-800 mb-4">
                        {error || t("careerApplication.notFound")}
                    </h2>
                    <p className="text-gray-600 mb-6">
                        {t("careerApplication.notFoundText")}
                    </p>
                    <AppBaseButton
                                ...
                                <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
                                    <p className="text-gray-700 leading-relaxed">
                                        <Trans i18nKey="careerApplication.instruction">
                                            <strong>Rejoignez Scar-Soft</strong>{" "}
                                            en nous envoyant votre CV + lettre
                                            de motivation à
                                            <a href="mailto:rh@scar-soft.net">
                                                rh@scar-soft.net
                                            </a>
                                            .
                                        </Trans>
